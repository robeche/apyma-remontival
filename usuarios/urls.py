...
urlpatterns = [
    ...
    path('consejos-educativos/', views.consejos_educativos, name='consejos_educativos'),
    path('consejos-educativos/crear/', views.crear_consejo, name='crear_consejo'),
    path('consejos-educativos/<slug:slug>/', views.consejo_detalle, name='consejo_detalle'),
    path('consejos-educativos/<slug:slug>/editar/', views.editar_consejo, name='editar_consejo'),
    path('consejos-educativos/<slug:slug>/eliminar/', views.eliminar_consejo, name='eliminar_consejo'),
    path('consejos-educativos/<slug:slug>/imagen/subir/', views.subir_imagen_consejo, name='subir_imagen_consejo'),
    path('consejos-educativos/imagen/<int:imagen_id>/eliminar/', views.eliminar_imagen_consejo, name='eliminar_imagen_consejo'),
